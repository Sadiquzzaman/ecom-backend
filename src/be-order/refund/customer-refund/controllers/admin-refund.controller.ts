...
export class AdminRefundController {
  ...
  getRefundRequestPaginatedList(
    ...
    const confirmedOrders = this.adminRefundService.pagination(
      pagination.page,
      pagination.limit,
      pagination.sort,
  ...
  getRefundRequestPaginatedListForCustomer(
    ...
    const confirmedOrders = this.adminRefundService.paginationForCustomer(
      pagination.page,
      pagination.limit,
      pagination.sort,
      pagination.order === 'ASC' ? 'ASC' : 'DESC',
  ...
  getShopInvoicesAndAssignmentsOfOrder(
    ...
    const invoices = this.adminRefundService.getShopInvoicesOfAnOrder(id);
  ...
  findById(
    ...
    const customerRefund = this.adminRefundService.findById(id, refundStatus);
  ...
  create(
    ...
    const refundRequestData = this.adminRefundService.create(
      customerRefundRequestDto,
    );
    return this.responseService.toDtoResponse(
      HttpStatus.OK,
  ...
  updateRefundRequestStatus(
    ...
    const updatedData = this.adminRefundService.updateRefundRequestStatus(
      id,
      dto,
    );
  ...
  @HttpCode(HttpStatus.OK)
  @Patch('reject-refund-request/:id')
  rejectRefundRequest(
    @Param('id', new UuidValidationPipe()) id: string,
    @Body(
      new DtoValidationPipe({ whitelist: true, forbidNonWhitelisted: true }),
    ...
    const updatedData = this.adminRefundService.rejectRefundRequest(id, dto);
    return this.responseService.toDtoResponse<CustomerRefundRequestDto>(
      HttpStatus.OK,
      'Refund Request Updated',
      updatedData,
