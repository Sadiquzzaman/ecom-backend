  ...
  implements GeneralController<ShopTypeDto, ResponseDto>
{
  ...
  @ApiOkResponse({
    ...
    description: 'Get the list of all Shop Types',
  })
  ...
  @ApiOkResponse({
    status: HttpStatus.OK,
    description: 'Get a single Shop Type',
  })
  @HttpCode(HttpStatus.OK)
  @Post('find')
  findOne(
  ...
  @ApiOkResponse({
    status: HttpStatus.OK,
    description: 'Get the pagination list of Shop Types',
  })
  @HttpCode(HttpStatus.OK)
  @Get('pagination')
  pagination(
  ...
  @ApiCreatedResponse({
    ...
    description: 'Shop Type added successfully',
  })
  ...
  @ApiOkResponse({
    status: HttpStatus.OK,
    description: 'Shop Type is updated successfully',
  })
  @ApiBody({ type: ShopTypeDto })
  @HttpCode(HttpStatus.OK)
  @Put(':id')
  update(
    ...
    return this.responseService.toDtoResponse(
      HttpStatus.OK,
      'Shop Type is updated successfully',
      type,
    );
  }
  ...
  @ApiOkResponse({
    status: HttpStatus.OK,
    description: 'Shop Type is deleted successfully',
  })
  @HttpCode(HttpStatus.OK)
  @Delete(':id')
  remove(
    ...
    return this.responseService.toResponse(
      HttpStatus.OK,
      'Shop Type is deleted successfully',
      deleted,
    );
  }
}
