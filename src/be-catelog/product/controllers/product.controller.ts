  ...
  implements GeneralController<ProductDto, ResponseDto>
{
  ...
  productApproval(
    ...
    const productApprovalUpdate =
      this.productService.updateApprovalStatus(modifiedDto);
  ...
  approvalPagination(
    ...
    const products = this.productService.approvalPagination(
      page,
      limit,
      sort,
      order,
  ...
  stock(
    ...
    const products = this.productService.stock(page, limit, sort, order);
    return this.responseService.toPaginationResponse(
      HttpStatus.OK,
      null,
      page,
  ...
  create(
    ...
    throw new SystemException(
      new ForbiddenException('Sorry !!! You are not authorized.'),
    );
